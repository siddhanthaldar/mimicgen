...
# import sys
# sys.path.append("/Users/siddhanth/github/LIBERO")
...
def get_env(task_bddl_files, task_benchmark=None, bddl_file_name=None, task_id=None):
    ...
    controller_config = load_composite_controller_config(default_controller="OSC_POSE")
    config = {
        "env_name": env_name,
...
if __name__ == "__main__":
    ...
    if args.reset:
        if args.output is None:
            args.output = "reset_{}_{}.mp4".format(args.task_benchmark, args.task_id)
        # write a video
